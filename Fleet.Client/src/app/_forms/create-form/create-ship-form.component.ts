...
@Component({
  ...
  template: `
    <form nz-form [nzLayout]="'vertical'" [formGroup]="createForm">
      <nz-form-item>
        <nz-form-control nzErrorTip="Please input a ship name!">
      ...
      <nz-form-item>
        <nz-form-control
          ...
          <nz-input-group>
            <input type="number" min="1" max="4" formControlName="capacity" nz-input/>
          </nz-input-group>
        </nz-form-control>
      </nz-form-item>
    </form>
...
export class CreateShipFormComponent {
